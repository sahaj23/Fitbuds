    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Fit Buds</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="customize-diet.html">
                    <i class="fas fa-fw fa-utensils"></i>
                    <span>Customize Diet</span></a>
            </li>
            <li class="nav-item active">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Area Chart -->
                        <div class="col-xl-8 col-lg-12" style="column-width: 200">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        ...
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Carbohydrate
                                        </span>
                                        <span class="mr-2">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xl-4">
                            <div class="card shadow mb-4">
                                ...
                                <table class="table table-hover table-condensed"><tbody><tr><td>
                                    Monday
                                 </td><td>
                        ...
                        <div class="col-lg-12 col-xl-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Nutrition Plan</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                        </a>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <!-- <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row border border-grey rounded my-3 p-2">
                                        <div class="col-2 d-block">
                                            <h6 class="align-middle">17-3-19</h6>
                                        </div>
                                        <div class="col-1">
                                            <i class="fas fa-running fa-circle" style="color:#4e73df"></i>
                                        </div>
                                        <div class="col-9">
                                            <h5 class="text-primary">Running</h5>
                                            <h6>claories burned - <span> 200 </span></h6>
                                            <h6>time of activity <span> 1 hour 30 min </span></h6>
                                        </div>
                                    </div>
                                    <div class="row border border-grey rounded my-3 p-2">
                                        <div class="col-2 d-block">
        ...
        <script src="js/display-details.js"></script>
